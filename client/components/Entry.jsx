...
class Entry extends React.Component {
	...
	render() {
		return (
			<div id="entrydiv">
			<Item id="entry">
				<Item.Image size="small" as="a" href={this.props.event.event.url} target="_blank" src={this.props.event.event.image}/>
	      <Item.Content>
	        <Item.Header as="a" href={this.props.event.event.url} target="_blank">{this.props.event.event.name}</Item.Header>
